...
img_names = pd.read_csv(pre_path+"/MPOX/MPOXDBASE.csv")['Data'].values
img_labels = pd.read_csv(pre_path+"/MPOX/MPOXDBASE.csv")['Disease'].values
#%% Train_test_split
X_train, X_test, y_train, y_test = train_test_split(img_names,img_labels,test_size = 0.3, shuffle = True)
